...
function noHayCoincidencia(){
    limpiarHTML()


    const noHayCoincidencia = document.createElement('div')
    noHayCoincidencia.classList.add('alerta','error')
    noHayCoincidencia.textContent = 'No hay coincidencias, realice otra búsqueda'
    resultado.appendChild(noHayCoincidencia)
}
